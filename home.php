         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="h_min" class="input" required>
                  ...
                  <option value="100000">7,000</option>
                  ...
                  <option value="6000000">60 000</option>
                  <option value="7000000">70,000</option>
                  <option value="8000000">8,000</option>
                  <option value="9000000">90,000</option>
                  ...
                  <option value="100000000">10 ,000</option>
                  <option value="150000000">15,000</option>
                  <option value="200000000">20,000</option>
               </select>
            </div>
            <div class="box">
               <p>maximum budget <span>*</span></p>
               <select name="h_max" class="input" required>
                  ...
                  <option value="6000000">60 000</option>
                  <option value="7000000">70 ,000</option>
                  <option value="8000000">80 ,000</option>
                  <option value="9000000">90, 000</option>
                  <option value="10000000">1 ,0000</option>
                  <option value="20000000">2 ,000</option>
                  <option value="30000000">3 ,000</option>
                  <option value="40000000">4 ,000</option>
                  <option value="50000000">5 ,000</option>
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><i class="fas fa-kenyan-shillings-sign"></i><span><?= $fetch_property['price']; ?></span></div>
